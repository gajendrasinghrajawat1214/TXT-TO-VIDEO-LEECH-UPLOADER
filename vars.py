...
FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "Gajju82bot")  # Channel username without @, 
FORCE_SUB_CHANNEL_LINK = environ.get("FORCE_SUB_CHANNEL_LINK", "https://t.me/Gajju82bot")  # Channel link
